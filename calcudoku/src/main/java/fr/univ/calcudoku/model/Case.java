...
public class Case implements ElementVisitable {
    ...
    /**
     * Indique si la case est une hypothèse.
     * @return true si la case est en mode hypothèse
     */
    public boolean isEstHypothese() { return estHypothese; }

    /**
     * Définit si la case est une hypothèse.
     * @param estHypothese true pour activer le mode hypothèse sur cette case
     */
    public void setEstHypothese(boolean estHypothese) { this.estHypothese = estHypothese; }
