...
public class Options extends Donnees {
    ...
    public AideAuCalcul getAide() { return aide; }
    public void setAide(AideAuCalcul aide) { this.aide = aide; }

    public boolean isThemeSombre() { return themeSombre; }
    public void setThemeSombre(boolean themeSombre) { this.themeSombre = themeSombre; }
